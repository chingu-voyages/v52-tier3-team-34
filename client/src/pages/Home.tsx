      ...
      <div className="space-y-6">
        <div className="space-y-4 w-full min-w-48">
          ...
          >
            ...
            <div className="absolute -inset-0.5 bg-gradient-to-r rounded-full from-purple-600 to-pink-600  opacity-75 group-hover:opacity-100 transition-all duration-300 blur-sm group-hover:blur-lg"></div>

            <div className="relative flex items-center justify-center bg-black/80 py-4 rounded-full hover:bg-transparent transition-colors duration-300 ease-in-out">
          ...
          <Link to="/dashboard" className="relative w-full block group">
            ...
            <div className="relative px-6 flex items-center justify-center bg-black/80 text-green-600 py-4 rounded-lg hover:bg-transparent transition-colors duration-300 ease-in-out">
              <Plus
