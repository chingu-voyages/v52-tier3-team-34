...
function EventDetails({ eventResponse, onDelete, onSave }: EventDetailsProps) {
  ...
  function handleInputChange<K extends keyof typeof eventDetails>(field: K, value: (typeof eventDetails)[K]) {
  ...
  function handleVenueChange<K extends keyof Venue>(field: K, value: Venue[K]) {
    setEventDetails((prev) => ({
      ...prev,
      venue: {
        ...prev.venue,
